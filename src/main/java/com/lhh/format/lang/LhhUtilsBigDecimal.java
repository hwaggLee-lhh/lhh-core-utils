...
public class LhhUtilsBigDecimal {
    public static final Logger log = Logger.getLogger(LhhUtilsBigDecimal.class);
    ...
    public static String valueOfScale(String str, int scale) {
        ...
        try {
            ...
            propertyDecimal = LhhUtilsBigDecimal.setScale(scale, propertyDecimal);
