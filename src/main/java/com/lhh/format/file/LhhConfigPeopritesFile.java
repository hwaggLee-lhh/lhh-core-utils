...
public class LhhConfigPeopritesFile {
    public static final Logger log = Logger.getLogger(LhhConfigPeopritesFile.class);
     ...
     */
    public LhhConfigPeopritesFile(String fileName, String charsetName) {
