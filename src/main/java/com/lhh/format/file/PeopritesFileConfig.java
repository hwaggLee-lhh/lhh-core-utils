...
public class PeopritesFileConfig {
    public static final Logger log = Logger.getLogger(PeopritesFileConfig.class);
     ...
     */
    public PeopritesFileConfig(String fileName, String charsetName) {
