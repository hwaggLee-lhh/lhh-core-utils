...
public class LhhUtilsPassword {
    public static final Logger log = Logger.getLogger(LhhUtilsPassword.class);
    ...
    public static String getFilePathPassswordComplexity() {
        return new LhhUtilsPassword().getClass().getClassLoader().getResource("passwordComplexityMan.properties").getPath();
    }
...
//        valueRegx = valueRegx.substring(0 , valueRegx.length() -5);
        System.out.println(LhhUtilsPassword.md5("18616818966=-0987654321`"));
    }
