...
public class LhhUtilsHttpPoolClient {

    private static final String TAG_CHARSET = "charset=";

    private final static Logger logger = LoggerFactory.getLogger(LhhUtilsHttpPoolClient.class);
    ...
    public LhhUtilsHttpPoolClient() {

    }

    public LhhUtilsHttpPoolClient(int conntimeout, int sotimeout) {
        this.sotimeout = sotimeout;
        this.conntimeout = conntimeout;
    }

    public LhhUtilsHttpPoolClient(int maxConnection, int conntimeout, int sotimeout) {
        this(conntimeout, sotimeout);
        this.maxConnection = maxConnection;
    }

    public LhhUtilsHttpPoolClient(int maxConnection, String charset, int conntimeout, int sotimeout) {
        this(conntimeout, sotimeout);
        this.maxConnection = maxConnection;
        this.reqCharset = charset;
    }

    public LhhUtilsHttpPoolClient(int maxConnection) {
        this.maxConnection = maxConnection;
    }

    public LhhUtilsHttpPoolClient(int maxConnection, String charset) {
        this.maxConnection = maxConnection;
        this.reqCharset = charset;
    }

    public LhhUtilsHttpPoolClient(int maxConnection, String charset, String resCharset) {
        this.maxConnection = maxConnection;
        this.reqCharset = charset;
    ...
    public String getData(String url) throws IOException {
        return fetchData(createGet(url, Collections.<NameValuePair> emptyList(), null));
    }

    public String getData(String url, ApplicationType type) throws IOException {
        return fetchData(createGet(url, Collections.<NameValuePair> emptyList(), type));
    }
